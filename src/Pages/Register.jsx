...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:4005/user/register', {
        method: 'POST',
      ...
      if (response.status === 201) {
        setToastMessage('Registered successfully! Redirecting...');
        setShowToast(true);
        setTimeout(() => {
        ...
        setToastMessage(msg.message || 'Registration failed');
        setShowToast(true);
      }
    } catch (err) {
    ...
    <div className="d-flex justify-content-center align-items-center min-vh-100" 
      ...
      <div className="card p-4" style={{ 
        ...
        <div className="card-body">
          ...
          {showToast && (
            <div className={`alert ${toastMessage.includes('success') ? 'alert-success' : 'alert-danger'} py-2`} role="alert" style={{ borderRadius: '8px' }}>
              <i className={`bi ${toastMessage.includes('success') ? 'bi-check-circle' : 'bi-exclamation-circle'} me-2`}></i>
              {toastMessage}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-3">
              <label className="form-label fw-semibold" style={{ color: '#2c3e50' }}>Full Name</label>
          ...
          <div className="mt-4 text-center pt-3 border-top">
            <p className="text-muted mb-0 ">
              ...
              <Link to="/login" className="ms-1 fw-semibold" style={{ color: '#3498db', textDecoration: 'none' }}>
                Login Now
              </Link>
            </p>
          </div>
